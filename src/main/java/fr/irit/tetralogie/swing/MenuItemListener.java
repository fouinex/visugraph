...
import fr.irit.tetralogie.model.Arete;
import fr.irit.tetralogie.model.ForceDirect;
import fr.irit.tetralogie.model.Sommet;

public class MenuItemListener implements ActionListener {

	private String forme[][]= new String[2][6];  /** On crée une matrice qui comportera toutes formes possibles de sommets. 
													 Nous codons 'O' si la forme est selectionnée dans le menu, 'N' si elle ne l'est pas **/
    private GraphPanel gp;
    JMenuBar barreMenus;
    JMenu Animation, Labels, Representation, Clustering, icones, edition, ecran, Morphing, Aide;
	...
	PV, blanc, noir, Seuil, Seuil2, Repere, aid, init;
...
/*
 * On souligne la première lettre de Edition, montrant ainsi une tête de liste
 * d'item
 */
	...
	/*
	 * Gestion de l'individualité de la coche : si on coche "Histo Fixe", on ne
...
/*	Seuil2 = new JMenuItem ("Transitivité par instance");
	 ...
	 * barre de l'histogramme représente une instance (Histo Fixe), soit seule la
	 * barre de l'histogramme, correpondant à l'instance en cours, change de
	 * couleur.
	 */
...
/*
 * Gestion de l'individualité de la coche : si on coche "Histo Fixe", on ne peut
...
/*
 * Gestion de l'individualité de la coche : si on coche "sans", on ne peut pas
 ...
 */
	...
	// type de dessin
		...
		/*
		 * on est dans le cas où cercle a été coché ou décoché. on veut gérer
		 * alors la coche de classe et avoir les deux à la fois (classe et
		 * cercle). on réapplique l'algorithme qui trace les classes et on
